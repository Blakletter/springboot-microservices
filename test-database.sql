CREATE DATABASE  IF NOT EXISTS `login_test` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `login_test`;
...
CREATE TABLE `login` (
  ...
  `account_enabled` tinyint DEFAULT '0',
